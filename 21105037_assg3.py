...
given_table = [ ["A+","Outstanding",10],
                ...
                ["C","Below Average",5],
                ["D","Poor",4] ]
while True:                                                                                                         #loop so that user inputs the value between 4 and 10
